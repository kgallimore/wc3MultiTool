...
<div class="py-2">
  <div>
    <div class="image-border top-bar w-11/12 top-2 mx-4" style="height:39px;" />
    <div class="image-border bottom-bar w-11/12 bottom-4 mx-4" style="height:39px" />
    <div class="image-border left-bar h-5/6 left-0 w-9 my-4" />
    <div class="image-border right-bar h-5/6 right-0 w-9 my-4" />
              ...
              <div class="container">
                ...
                <form id="clientForm" name="client" class="p-2 border">
                  <div class="row m-2">
                    ...
                    <div class="row">
                      <div class="col">
                        <label for="releaseChannel" class="form-label"
                                  ...
                                  {:then value}
                                    ...
                                    {#each value as option}
                                      <option
                                        ...
                                        >{option.key.ladder}, {option.key.mode}, {option
                                          .key.round}, {option.key.season}</option
                                      >
                                    {/each}
                                  {/await}
                                </select>
                    ...
                    <div class="col">
                      <label for="autoHostState" class="form-label">
                        <details>
                          ...
                          <strong>Rapid Host:</strong> Hosts lobbies, auto starts, leaves
                          the game after specified timer(minutes). (-1 will force quit at
                          loading screen)<br />
                          <strong>Smart Host:</strong> Hosts lobbies, auto starts, quits
                          the game if you use the wc3mt lib (see discord), with a fallback
                          to attempting to see if this screen opens(OCR, unreliable):
                          <img class="img-fluid" src="quitNormal.png" alt="Quit Normal" />
                          Intrusive Check will check the chat menu to see if anyone else is
                          left.
                        </details>
                      </label>
                      <select
                      ...
                      >
                        <option value="off">Disabled</option>
                        <option value="lobbyHost"
                          >Lobby Host: Host but don't autostart</option
                        >
                        ...
                        <div class="col">
                          ...
                          <div class="btn-group btn-group-sm w-100 py-1" role="group">
                            {#each Array.from(Array(12).keys()) as i}
                              <CloseSlot
                                checked={settings.autoHost.closeSlots.includes(i) ??
                                  false}
                                on:change={(e) => {
                                  updateSettingSingle(
                                    "autoHost",
                            ...
                            <input
                              ...
                              on:change={(e) =>
                                updateSettingSingle(
                                  ...
                                  "voteStartPercent",
                                  Math.min(
                                    Math.max(parseInt(e.currentTarget.value), 5),
                                    100
                                  )
                                )}
                            />
                      ...
                      <div class="row p-2">
                        <div class="col">
                          ...
                          >
                            ...
                            <option
                              disabled={settings.client.alternateLaunch}
                        ...
                        {#if settings.autoHost.regionChangeType === "both" || settings.autoHost.regionChangeType === "openVPN"}
                          <div class="row p-2">
                            <div class="col">
                              ...
                              <span
                                class={settings.autoHost.openVPNPath
                                  ? ""
                                  : "alert-warning"}
                                >{settings.autoHost.openVPNPath ||
                                  "Please set a path."}</span
                              >
                            </div>
                          </div>
                          <div class="row p-2">
                ...
                <form name="obs" class="p-2">
                  ...
                  {#if settings.obs.enabled}
                    <div class="border m-2 p-2">
                      <div class="row">
                        ...
                        <div class="row">
                          <div class="col">
                            ...
                            randomized intervals to jump to POIs. Incompatible with
                            intrusive check.<br /><strong>Text source:</strong> Outputs loby
                      ...
                      <div class="row">
                        <div class="col">
                          <label for="obsSelect" class="form-label"
                            >Scene Switch Type</label
                          >
                          <select
                            id="obsSelect"
                            class="form-select"
                          ...
                          <div class="row">
                            <div class="col">
                              ...
                              <input
                                ...
                                on:keydown={(event) =>
                                  generateHotkeys(event, "inGameHotkey")}
                                value={settings.obs.inGameHotkey
                                  ? (settings.obs.inGameHotkey.shiftKey
                                      ? "Shift + "
                                      : "") +
                              ...
                              <input
                                ...
                                value={settings.obs.outOfGameHotkey
                                  ? (settings.obs.outOfGameHotkey.shiftKey
                                      ? "Shift + "
                                      : "") +
                                    (settings.obs.outOfGameHotkey.ctrlKey
                                      ? "Ctrl + "
                                      : "") +
                                    (settings.obs.outOfGameHotkey.altKey
                                      ? "Alt + "
                                      : "") +
                      ...
                      {:else if settings.obs.sceneSwitchType === "websockets"}
                        <div class="border m-2">
                          <div class="row">
                            <div class="col">
                              <label for="obsAddress"
                                >OBS Address(Blank for unchanged)</label
                              >
                              <input
                                type="text"
                                class="form-control"
          ...
          <div class="row justify-content-center p-2">
            <div class="col d-flex text-xs">
              <details>
                ...
                ?perm (name) (?admin|mod|swapper): Promotes a player to a specified role (mod
                by default).<br />
  ...
  <div class="flex fixed bottom-0" style="	z-index: 10000;">
    <div class="launch-button content-center">
      <div class="h-4" />
    ...
    <span
      class="connection-status {gameState.connected ? 'online' : 'offline'}"
      id="mainStatus"
    >
      <div class="h-8" />
      <h2 class="coture text-center" id="statusText">
        <strong
          >{gameState.connected
            ? "CONNECTED TO WARCRAFT"
            : "WAITING FOR CONNECTION"}</strong
        >
      </h2>
    </span>
  </div>
