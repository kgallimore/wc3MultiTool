...
export class Module extends Global {
  ...
  protected onErrorLog(name: string, ...events: unknown[]) {}

  protected onWarnLog(name: string, ...events: unknown[]) {}

  protected onInfoLog(name: string, ...events: unknown[]) {}
  protected onVerboseLog(name: string, ...events: unknown[]) {}
