  ...
  $: botAnnouncement = `Welcome. I am a bot. ${
    $appSettings.elo.available && $appSettings.elo.type !== "off"
      ? `I will fetch ELO from ${$appSettings.elo.type}. ${
          $appSettings.elo.balanceTeams
            ? "I will try to balance teams before we start."
            : ""
        }`
      : ""
  }${
  ...
  <div class="row">
    <div class="col">
      <label for="autoHostState" class="form-label">
        <details>
          <summary>Auto Host Details (click to expand)</summary><strong
            >Lobby Host:</strong
          >
    ...
    <div id="autoHostSettings" class="border m-2">
      ...
      <div class="row p-2">
        ...
        {#if $appSettings.autoHost.type === "rapidHost"}
          <div class="col">
            <label for="rapidHostTimer" class="form-label">Rapid Host Timer</label>
            <input
              type="number"
              id="rapidHostTimer"
              class="form-control"
      ...
      {#if $appSettings.autoHost.announceCustom}
        <div class="row p-2">
          <div class="col">
            <label for="customAnnouncement" class="form-label">Custom Announcement</label>
            <input
              type="text"
      ...
      <div class="row p-2">
        <div class="col">
          ...
          >
            ...
            <option disabled={$appSettings.client.alternateLaunch} value="realm"
              >Bnet Realm</option
            >
            <option value="openVPN">OpenVPN</option>
            <option disabled={$appSettings.client.alternateLaunch} value="both"
              >Both</option
            >
          </select>
        </div>
